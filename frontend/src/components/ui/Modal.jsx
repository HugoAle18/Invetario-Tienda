...
export default function Modal({ open, onClose, title, children }) {
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 text-gray-900 dark:text-white border border-slate-200 dark:border-slate-800/80 rounded-xl shadow-2xl max-h-[90vh] flex flex-col">
